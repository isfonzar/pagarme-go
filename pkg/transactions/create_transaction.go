...
const transactionsBaseEndpoint = "transactions"
...
func (t *CreateTransaction) Create(client client.Client) (*Transaction, error) {
	req, err := json.Marshal(&t)
	if err != nil {
		return nil, err
	}

	resp, err := client.Request(http.MethodPost, transactionsBaseEndpoint, req)
	if err != nil {
		return nil, err
	}
